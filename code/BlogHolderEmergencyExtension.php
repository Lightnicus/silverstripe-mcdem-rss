...
class BlogHolderEmergencyExtension extends DataExtension{
	...
	function updateCMSFields(FieldList $fields){
		$fields->addFieldToTab('Root.RSS', new CheckboxField('EmergencyFeed', 'Is this Blog an MCD Emergency Feed'));
...
class BlogHolderControllerEmergencyExtension extends Extension {
